python run_summarization.py \
    ...
    --do_eval \
    --logging_first_step \
    --output_dir "/gscratch/argon/artidoro/eventsrealm/real_events/data/gold-v1.1-prompt-t5-merged-entities-single_prompts-out_domain-k_prompts-1-single-all-all-test" \
